...
const ProjectModernSlider: React.FC = () => {
  ...
  const updateDragButtonPosition = useCallback((x: number, y: number) => {
  ...
  }, [isOverNavButton, isInSection, updateDragButtonPosition]);
  ...
  }, [isInSection, isOverNavButton, showDragBtn, updateDragButtonPosition]);
  ...
  }, [isOverNavButton, updateDragButtonPosition]);
  ...
  const handleDragMove = useCallback((e: MouseEvent) => {
    ...
    setDragPosition({ x: e.clientX, y: e.clientY });
    updateDragButtonPosition(e.clientX, e.clientY);
  }, [isDragging, updateDragButtonPosition]);
